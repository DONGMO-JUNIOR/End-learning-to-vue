  ...
  <section class="bg-gray-50 py-16 px-6">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
      ...
      <div class="md:w-1/2 flex justify-center">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="800.283" height="459.452" 
       viewBox="0 0 800.283 459.452" xmlns:xlink="http://www.w3.org/1999/xlink" 
       role="img" artist="Katerina Limpitsouni" 
       source="https://undraw.co/"><g transform="translate(-560.001 -310)"><g transform="translate(595.918 441.564)">
        <path d="M456.278,312.134h0a12.465,12.465,0,0,0-5.2-3.049L436.759,293.47l-7.552,7.24,15.349,15.064a12.238,12.238,0,0,0,3.26,5.033c3.674,3.511,8.544,4.415,10.88,2.017s1.263-7.179-2.4-10.684h-.014Z" transform="translate(-327.646 -170.988)" fill="#9f616a"/>
        <path d="M515.059,270.541l-7.607,9.563-39.318-29.762-.034-.068L445.124,207.4a14.706,14.706,0,1,1,26.7-12.2l14.908,39.019,28.329,36.309Z" transform="translate(-392.397 -136.424)" fill="#d6d6e3"/>
...
<!-- <template>
  <section class="relative overflow-hidden bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        
        <div class="text-white space-y-8">
          <div class="space-y-4">
            <p class="text-lg font-medium text-yellow-300 italic">
              {{ subtitle }}
            </p>
            <h1 class="text-4xl lg:text-6xl font-bold leading-tight">
              {{ title.split(' ').slice(0, 1).join(' ') }}<br>
              <span class="text-white">{{ title.split(' ').slice(1).join(' ') }}</span>
            </h1>
          </div>
        ...
        <div class="relative">./ui/BaseButton.vue'
          <KidIllustration />
          <FloatingShapes />
        </div>
      </div>
...
import KidIllustration from '/ui/KidIllustration.vue'
import FloatingShapes from './ui/FloatingShapes.vue'
import WaveDecoration from './ui/WaveDecoration.vue'
...
const props = withDefaults(defineProps<Props>(), {
  ...
  buttonText: 'Continue to explore →'
})
